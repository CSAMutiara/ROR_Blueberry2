class ReferencesController < ApplicationController
  ...
  private
    ...
    def reference_params
      params.require(:reference).permit(:books, :grants, :stcollabs, :facollabs, :aebcreferences, :efvreferences, :wcpitreferences, :pcmreferences, :cifwreferences, :ahareferences)
    end
end
